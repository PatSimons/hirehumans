...
(() => {
  ...
  function initSlider(slider) {
    ...
    function setupAutoPlay() {
      const autoplay = setInterval(() => goNext(), 5e3);
    }
    function setupIndicators() {
      ...
      indicatorsArray.forEach((indicator2, index) => {
        indicator2.addEventListener("click", () => slideAction(null, index));
      });
